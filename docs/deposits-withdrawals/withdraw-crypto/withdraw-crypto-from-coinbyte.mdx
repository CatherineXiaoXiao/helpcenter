...
To withdraw any asset on CoinByte, you must first add and verify a withdrawal address, please refer to <strong>[Add a crypto wallet address](/helpcenter/docs/user-guide/crypto-wallet)</strong>.
...
<figure style={{ textAlign: 'center' }}>
  <img src="https://downloads.intercomcdn.com/i/o/t32wgff3/1558109572/f0fade4051f116358d569dc9468a/image.png?expires=1749159000&signature=1615bb4b913dccd934a9fab4c44a5bf50e7ffc2db971439b5c571ac3ba922017&req=dSUiHsh%2BlIRYW%2FMW1HO4zcjWlMHiCQXkpAdKBbDk900UzMgUZhXMxYstD8K3%0A%2BWun%0A" style={{ width: 300 }} />
</figure>

<li>Select the withdrawal address from the list.</li>
<li>If it is your first withdrawal of this crypto asset, you need to add a withdrawal address. Please read <strong>[Add or remove a crypto withdrawal wallet address](/helpcenter/docs/user-guide/crypto-wallet)</strong>.</li>
<li>Enter the amount of the asset you want to withdraw, review the fees and withdrawal amount.</li>

<figure style={{ textAlign: 'center' }}>
  <img src="https://downloads.intercomcdn.com/i/o/t32wgff3/1558122647/f472d6fab3692e77313679a31be9/image.png?expires=1749159000&signature=eda3d7c1b9b348be921cde1c2fb1e56fa8b238945353586716fedc6646252fd5&req=dSUiHsh8n4dbXvMW1HO4zUvb7BZu4raiXT7t2g0N4Z9%2FyL8Rht9gqO%2BWRT7r%0ARjoD%0A" alt="Withdrawal details1" style={{ width: 300 }} />
</figure>
...
- Minimum withdrawal amounts differ depending on the asset and the chosen network. To see minimum withdrawal amounts for all of the assets listed on CoinByte, visit our <strong>[network withdrawal fees page](#)</strong>.
...
For more, please refer to our <strong>[Terms of Services](/helpcenter/docs/user-guide/terms-and-compliance/term-of-services)</strong>.
